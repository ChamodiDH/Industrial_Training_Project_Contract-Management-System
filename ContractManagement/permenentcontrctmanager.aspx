<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="permenentcontrctmanager.aspx.cs" Inherits="ContractManagement.WebForm8" %>
    ...
    <section>
       ...
       <div class ="container">
            ...
            <div class ="row">                                                                          <%--  THIS ROW IS FOR ADDING MAIN ACTIONS // ADD ANY NUMBER OF COLUMNS,ROWS AS YOU WANT --%>
                  ...
                  <div class ="col-md-3">
                      <center>
                          <a href="estimation.aspx">                                                 <%--  E4/ CALL YOUR 1ST PAGE HERE :- XXX.aspx --%>
                ...
                <div class ="col-md-3">
                      <center>
                          <a href="searchestimationmat.aspx">                                                <%--  E7/ CALL YOUR 2nd PAGE HERE :- XXX.aspx --%>
                ...
                <div class="col-md-3">
                     <center>
                          <a href="searchestimationlab.aspx">                                    <%--  E11/ CALL YOUR 3rd PAGE HERE :- XXX.aspx --%>
                ...
                <div class="col-md-3">
                     <center>
                         <a href="reportform.aspx">                                                   <%--  E15/ CALL YOUR 4th PAGE HERE :- XXX.aspx --%>
