<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="estimationpage2.aspx.cs" Inherits="ContractManagement.WebForm3" EnableEventValidation="false"  %>
     ...
     <div class="container-fluid">
                  ...
                  <div class="card" style="background:url(imgs/cv2.jpg)">
                      <div class="card-body">
                          <div class="row">
                              <div class="col">
                                  <center>
                                      <h4 style="font-family: Calibri; font-size: xx-large"><b>Labour Estimation</b></h4>
        ...
        <table border="1" class="auto-style1" style="font-family: 'Arial Black'; font-size: large; background-color: #FF9999;">
            <tr>
                ...
                <td class="auto-style5">Labour Role</td>
                <td class="auto-style10">Salary Per day</td>
                <td class="auto-style7">No.of days</td>
                <td class="auto-style7">No.of workers</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="5" style="font-family: Arial; font-size: medium; background-color: #FFCCFF">
                    <center><asp:Button ID="Button1" runat="server" Height="33px" Text="Add Data" Width="136px" OnClick="Button1_Click"  class="btn btn-warning"/></center>
                    
                </td>
            </tr>
            <tr>
                <td colspan="5" style="font-family: Arial; font-size: medium; background-color: #FFCCFF">
                    <center><asp:Button ID="Button3" runat="server" Height="33px" Text="Remove" Width="136px" OnClick="Button3_Click"  class="btn btn-warning"/></center>
                ...
                <div class="card"style="background:url(imgs/cv2.jpg)">
                      <div class="card-body">
                           ...
                           <div class="row">
                              <div class="col">
                                  <center>
                                      <h4 style="font-family: Calibri; font-size: xx-large"><b>Estimated Labour Cost</b></h4>
